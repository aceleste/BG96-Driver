...
class BG96Interface : public NetworkStack, public NetworkInterface, public GNSSInterface, public FSInterface
{
public:
    BG96Interface();
   ...
   /** Query registered state 
    ...
    /** InitializeBG96 module. Current implementation calls startup.
     * 
     */
